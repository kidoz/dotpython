...

{
    ...
    printf '  "packageInitializer": "anyver/__init__.py",\n'
    printf '  "packageInitializerSha256": "ba47d9b12385aae3a3c80639257d78d02bd358986265416843886d10da8e0b85",\n'
    printf '  "packageMetadata": "anyver-1.1.0.dist-info/METADATA",\n'
    printf '  "packageMetadataSha256": "694cf4e43015442df187f18527c51ecb9085790bdeae9987374e2016b3f8aa05",\n'
